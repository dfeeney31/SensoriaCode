...
outputAllConfigs = {'TrialNo','PrePost','PkHeel','varHeel','PkNav','VarNav','PkToe','VarToe'};
% constants
...
for s = 1:NumbFiles
    ...
    kinData = num2cell([pkHeel; varHeel;pkNav;varNav;pkBigToe;varBigToe]'); %modulate this to subject name and config
