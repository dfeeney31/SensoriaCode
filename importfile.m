...
%   X1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   X1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   x1 = importfile('136827-0x0000.csv', 12, 1146);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/01 12:12:38
